...
### 概要
- スタッフアカウント発行は**有料オプション**
- 実装はフェーズ3以降

### アクセス方式
| 種別 | 画面 | 用途 |
|------|------|------|
| 標準（スタッフ用） | `staff.html` | スタッフ自身が情報登録・入退店記録 |
| オプション（オーナー用） | `settings.html`（PC版） | オーナーがスタッフ情報を管理 |

### スタッフ登録情報
| 項目 | 閲覧 | 編集 |
|------|------|------|
| 氏名 | スタッフ・オーナー | スタッフ・オーナー |
| 生年月日 | スタッフ・オーナー | スタッフ・オーナー |
| 携帯電話 | スタッフ・オーナー | スタッフ・オーナー |
| 住所 | スタッフ・オーナー | スタッフ・オーナー |
| 登録日 | スタッフ・オーナー | 自動設定（変更不可） |
| 備考 | **オーナーのみ** | **オーナーのみ** |

### 注意事項
- 備考欄はオーナー専用（スタッフからは非表示・編集不可）
- スタッフ専用URL（staff.html）からスタッフ自身が情報登録・入退店記録を行う
- AI提案の自動確定禁止ルールは本機能にも適用
